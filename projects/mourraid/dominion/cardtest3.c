 ...
 * Tests the effect of the great_hall card
...
int main() {
    ...
    for (p = 0; p < numPlayer; p++)
    {
		...
		cardEffect(17, 1, 1, 1, &G, G.handCount[p], 1);		//since great_hall is implemented in cardEffect, the 2nd, 3rd, 4th, and 6th parameters should not matter
